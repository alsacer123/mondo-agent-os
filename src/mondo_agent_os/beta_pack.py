...
def build_first_beta_pack() -> str:
    ...
    sections = [
        ...
        f"   {ISSUE_URL}",
        "2. List three possible beta candidates and send the light outreach message.",
        "3. Fill the candidate intake record for the best respondent.",
        "4. Run the preflight from the repository root:",
        "   `python scripts/verify_all.py`",
        "5. Send or read the invitation message to the beta user.",
        "6. Host the onboarding with the runbook.",
        "7. Capture notes during the session.",
        "8. Fill the feedback form and retro after the session.",
        "9. Produce exactly one next improvement for the following beta run.",
        "",
