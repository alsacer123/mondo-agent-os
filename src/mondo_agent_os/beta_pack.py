...
PACK_SOURCES = [
    ...
    ("Beta candidate outreach", ROOT / "docs" / "beta-candidate-outreach.md"),
...
def build_first_beta_pack() -> str:
    ...
    sections = [
        ...
        f"   {ISSUE_URL}",
        "2. Check whether local beta materials are ready:",
        "   `mondo-os beta-status`",
        "3. List three possible beta candidates and send the light outreach message.",
        "4. Fill the candidate intake record for the best respondent.",
        "5. Run the preflight from the repository root:",
        "   `python scripts/verify_all.py`",
        "6. Send or read the invitation message to the beta user.",
        "7. Host the onboarding with the runbook.",
        "8. Capture notes during the session.",
        "9. Fill the feedback form and retro after the session.",
        "10. Produce exactly one next improvement for the following beta run.",
        "",
